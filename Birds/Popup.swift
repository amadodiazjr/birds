...
//  Birds
//
//  Created by Amado Diaz Jr on 11/7/18.
...
class Popup: SKSpriteNode {
    ...
    func setupPopup() {
        ...
        let menuButton = SpriteKitButton(defaultButtonImage: "popmenu", action: popupButtonnHandler, index: PopupButtons.menu)
        let nextButton = SpriteKitButton(defaultButtonImage: "popnext", action: popupButtonnHandler, index: PopupButtons.next)
        let retryButton = SpriteKitButton(defaultButtonImage: "popretry", action: popupButtonnHandler, index: PopupButtons.retry)
    ...
    func popupButtonnHandler(index: Int) {
        switch index {
